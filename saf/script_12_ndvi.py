#-------------------------------------------------------------------------------------------------------------------
# Training - Processing EUMETSAT Data and Products - Script 12: NDVI
...
file_name = 'METOP_AVHRR_20230711_S10_AMs_NDV.img'
data = np.fromfile(f'../samples/{file_name}',dtype='uint8')
...
# save the image
plt.savefig('image_12.png', bbox_inches='tight', pad_inches=0, dpi=300)
