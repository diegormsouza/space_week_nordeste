#-------------------------------------------------------------------------------------------------------------------
# Training - Processing EUMETSAT Data and Products - Script 23: Evapotranspiration (MSG)
...
file = Dataset("../samples/NETCDF4_LSASAF_MSG_ETv3_MSG-Disk_202307271500.nc")
...
# plot the image
img = ax.imshow(data, vmin=0, vmax=1, origin='upper', extent=img_extent, cmap='jet')
...
# add a colorbar
plt.colorbar(img, label='Evapotranspiration (mm/h)', extend='both', orientation='vertical', pad=0.03, fraction=0.05)
...
# add a title
plt.title(f'MSG/SEVIRI - Evapotranspiration\n{date}', fontweight='bold', fontsize=10, loc='left')
