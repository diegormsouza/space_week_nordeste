#-------------------------------------------------------------------------------------------------------------------
# Training - Processing EUMETSAT Data and Products - Script 22: 10-day Leaf Area Index
...
file = Dataset("../samples/NETCDF4_LSASAF_M01-AVHR_ETLAI_GLOBE_202307250000.nc")
...
# add a colorbar
plt.colorbar(img, label='10-day Leaf Area Index', extend='both', orientation='vertical', pad=0.03, fraction=0.05)
...
# add a title
plt.title(f'Metop/AVHRR - 10-day Leaf Area Index (m²/m²)\n{date}', fontweight='bold', fontsize=10, loc='left')
...
# save the image
plt.savefig('image_22.png', bbox_inches='tight', pad_inches=0, dpi=300)
