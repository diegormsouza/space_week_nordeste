#-------------------------------------------------------------------------------------------------------------------
# Training - Processing EUMETSAT Data and Products - Script 24: Total Downward Surface Shortwave Flux (MSG)
...
file = Dataset("../samples/NETCDF4_LSASAF_MSG_MDSSFTD_MSG-Disk_202307271500.nc")
...
# add a colorbar
plt.colorbar(img, label='Total Downward Surface Shortwave Flux (W/m²)', extend='both', orientation='vertical', pad=0.03, fraction=0.05)
...
# add a title
plt.title(f'MSG/SEVIRI - Total Downward Surface Shortwave Flux\n{date}', fontweight='bold', fontsize=10, loc='left')
